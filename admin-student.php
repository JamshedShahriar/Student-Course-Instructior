...
<div class="header-panel">
  <div class="container d-flex justify-content-between align-items-center">
    <h2 class="m-0 font-weight-bold">🌿 Student Database</h2>
    <div>
...
<div class="container">
  <div class="table-container">
    <h5 class="mb-3 font-weight-bold text-dark">Registered Students List</h5>
          ...
          while ($row = $result->fetch_assoc()) {
              echo "<tr>
                      ...
                      <td class='text-center'>
                        <a href='edit_student.php?id={$row['Student_ID']}' class='btn btn-sm btn-outline-primary me-1'>Edit</a>
                        <a href='delete_student.php?id={$row['Student_ID']}' class='btn btn-sm btn-outline-danger' onclick=\"return confirm('Are you sure?');\">Delete</a>
                      </td>
                    </tr>";
          }
          ?>
